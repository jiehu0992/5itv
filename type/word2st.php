...
$trees = array(
    ...
    array('id' => 3, 'min_gen' => 0, 'max_gen' => 5, 'min_dc' => 1, 'max_dc' => 6),
    array('id' => 5, 'min_gen' => 0, 'max_gen' => 2, 'min_dc' => 8, 'max_dc' => 9),       
);
...
foreach ($trees as $tree) {
    ...
    echo "<h2>{$node['id']}{$root_node['name']}的家谱</h2>";
    echo "<div class='tree'>";
    ...
    echo "<h4>{$node['id']}{$root_node['name']}的后代</h4>";
    if (isset($family_tree[$id])) {
